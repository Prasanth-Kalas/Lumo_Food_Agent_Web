...
const RESTAURANTS: RestaurantWithMenu[] = [
  ...
  {
    id: "r_pequods_lincoln_park",
    name: "Pequod's Lincoln Park",
    cuisine: ["pizza"],
    metro: "chicago",
    rating: 4.6,
    review_count: 5410,
    ...
    eta_minutes: 48,
    is_open: true,
    tags: ["deep dish", "pan pizza", "caramelized crust"],
    menu: [
      {
        id: "m_pq_pan_cheese",
        restaurant_id: "r_pequods_lincoln_park",
        name: "Pan Cheese Pizza (Large)",
        description: "Caramelized cheese crust, house tomato sauce, mozzarella.",
        price_cents: 2799,
        category: "Pan Pizza",
      },
      {
        id: "m_pq_pan_sausage",
        restaurant_id: "r_pequods_lincoln_park",
        name: "Pan Sausage Pizza (Large)",
        description: "Sausage, mozzarella, tomato sauce, caramelized edge.",
        price_cents: 3099,
        category: "Pan Pizza",
      },
      {
        id: "m_pq_pan_pepperoni",
        restaurant_id: "r_pequods_lincoln_park",
        name: "Pan Pepperoni Pizza (Large)",
        description: "Pepperoni cups, mozzarella, tomato sauce, caramelized edge.",
        price_cents: 3199,
        category: "Pan Pizza",
      },
      {
        id: "m_pq_garlic_bread",
        restaurant_id: "r_pequods_lincoln_park",
        name: "Garlic Bread",
